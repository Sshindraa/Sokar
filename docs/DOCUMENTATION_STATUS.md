...
| `architecture/adr-usage-ledger-and-costing.md` | `ACTIF`             | Ledger idempotent, compteurs voix, résolution tarifaire versionnée et limites de confidentialité documentés.                                                                | Charger les tarifs validés, ajouter SMS/email, rapprochement et tests Postgres concurrents. Les rollups sont recalculés par le scheduler horaire.              |
...
- Quotas commerciaux chiffrés et coûts fournisseurs rapprochés : le catalogue reste `UNPRICED` tant qu'une facture n'a pas fourni un tarif validé.
