...
| `architecture/adr-usage-ledger-and-costing.md` | `ACTIF`             | Ledger idempotent, compteurs voix, collecteurs SMS/WhatsApp/email, résolution tarifaire versionnée, projection de quotas et limites de confidentialité documentés.          | Charger les tarifs validés, ajouter le rapprochement et les tests Postgres concurrents ; les quotas restent non chiffrés. Les rollups sont recalculés par le scheduler horaire. |
