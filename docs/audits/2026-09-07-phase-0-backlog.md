...
| LAUNCH-P1-09 | Codex — CI/release                      | Empêcher une CI verte avec des parcours critiques ignorés              | rendre intégrations/E2E bloquants et inclure Connect                              | un échec volontaire empêche la promotion ; release candidate restaurable          | Smoke ajoutés ; premier run CI a révélé puis corrigé l'attente `networkidle` du widget ; panne volontaire à prouver |
