...
| Multi-site                               | 249 € / mois + 99 € / établissement supplémentaire | Compte, OWNER, quota payé et deux sites isolés             | Deux sites, membre limité, changement de site, facture `siteCount`, dépassement de quota et rollback | Fondation account/site, admin, sélecteur et Checkout compte codés ; staging ouvert |
...
- [ ] Billing Portal, prix annuels, TVA/HT-TTC et procédure d’annulation ;
...
Chaque activation doit référencer le commit, les variables attendues, les migrations, les smoke tests, la sauvegarde et la commande de rollback. La projection Stripe multi-site et le modèle account/site restent additifs : migration et backfill doivent être validés sur staging avant toute donnée réelle.
