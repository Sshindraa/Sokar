...
| Multi-site                               | 249 € / mois + 99 € / établissement supplémentaire | Compte, OWNER, quota payé et deux sites isolés             | Deux sites, membre limité, changement de site, facture `siteCount`, dépassement de quota et rollback | Staging : troisième site créé, quatrième refusé hors quota, suspension/réactivation validées, sélecteur isolé, portail sandbox 447 €/mois et rejeu webhook signé validés ; l’API vérifie maintenant l’appartenance Clerk avant écriture ; deux identités réelles et archivage du principal restent ouverts |
