...
| Multi-site                               | 249 € / mois + 99 € / établissement supplémentaire | Compte, OWNER, quota payé et deux sites isolés             | Deux sites, membre limité, changement de site, facture `siteCount`, dépassement de quota et rollback | Staging : site secondaire créé, sélecteur isolé, portail sandbox 447 €/mois validé ; membres, quota et Checkout signé restent ouverts |
...
Chaque activation doit référencer le commit, les variables attendues, les migrations, les smoke tests, la sauvegarde et la commande de rollback. La projection Stripe multi-site et le modèle account/site restent additifs. La migration et le backfill sont validés sur staging (10/10 restaurants historiques) et la release `main@d53916c` est déployée en production ; les preuves d'isolation réelle, de Checkout/webhook signé et de cohorte pilote restent nécessaires avant l'activation commerciale autonome.
