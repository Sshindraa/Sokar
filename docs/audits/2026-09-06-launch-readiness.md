...
| Santé instantanée            | `/health` public HTTP 200 ; DB, Redis, queues, Telnyx, Deepgram, Cartesia répondent                                                                                                                                                                 | Ne teste ni un dialogue complet, ni un SMS livré, ni le LLM Groq                                                       |
