...
| Administration          | Ajout de site avec quota, suspension/réactivation, site suspendu exclu du sélecteur ; l’écriture d’un membre vérifie désormais son appartenance à l’organisation Clerk et le changement de statut du principal transfère `isPrimary` dans une transaction | Invitation Clerk réelle, deux identités isolées et rejeu staging du transfert de principal |
