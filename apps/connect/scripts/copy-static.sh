#!/usr/bin/env bash
# Sokar Connect — Copie les assets statiques dans le build standalone.
#
...
#   - Lit .next/standalone/apps/connect/
#   - Copie .next/static/apps/connect/ → .next/standalone/apps/connect/.next/static/
#   - Copie public/ → .next/standalone/apps/connect/public/
