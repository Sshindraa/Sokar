/**
 * Canal A — Types publics et schémas Zod.
 *
 * Pas d'auth Clerk sur ces endpoints. Les données sont publiées
 * volontairement par le restaurateur (canalAPublished=true).
 *
 * Source de vérité du gating : RestaurantExposureSettings
 *   - canalAPublished autorise la page publique + réservation web
 *   - canalAAgentic autorise l'exposition agentic avancée
...
/** Sources "agentic" (nécessitent canalAAgentic=true) */
