/**
 * Smoke test end-to-end Canal A (T10.5).
 *
 ...
 *
 * Si ce test passe, on est sûr que la stack Canal A fonctionne
...
// complet Canal A bout en bout, mais il est trop couplé aux signatures
// internes de ReservationService / HoldService qui évoluent.
// Les tests unitaires (canal-a.routes.test.ts) couvrent déjà les 4
