 ...
 */
function handleFluxEvent(event: FluxEvent, session: CallSession, mgr: CallSessionManager): void {
  switch (event.type) {
    case 'UtteranceStart': {
 ...
 */
async function speakTtsStreamed(session: CallSession, text: string): Promise<void> {
