...
export async function rgpdRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.post('/api/rgpd/request-verification', async (req, reply) => {
  ...
  app.post('/api/rgpd/confirm-verification', async (req, reply) => {
  ...
  app.get('/api/rgpd/confirm-link', async (req, reply) => {
  ...
  app.post('/api/rgpd/erase', async (req, reply) => {
  ...
  app.post('/api/rgpd/export', async (req, reply) => {
  ...
  app.post('/api/rgpd/withdraw-marketing', async (req, reply) => {
    const parse = ExportSchema.safeParse(req.body);
    if (!parse.success) {
      return reply.status(400).send({ error: 'Invalid payload', details: parse.error.format() });
    }
