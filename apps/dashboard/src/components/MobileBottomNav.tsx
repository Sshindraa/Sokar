          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? 'text-brand' : 'text-muted-foreground active:text-foreground/70',
              )}
            >
              {/* Active indicator dot */}
              {active && (
                <span className="absolute top-1.5 h-[3px] w-5 rounded-full bg-brand animate-in fade-in zoom-in-75 duration-300" />
              )}
              <Icon
                size={20}
