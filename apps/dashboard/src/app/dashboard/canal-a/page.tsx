...
export default function ConnectDashboardPage() {
  ...
  const loadData = useCallback(() => {
    ...
    setLoading(true);
    Promise.all([
      get<ConnectSettings>(`restaurants/${orgId}/canal-a`),
  ...
  return (
    <div className="space-y-6">
      <OnboardingLockBanner task="canal-a-identity" />
      {/* ── Header ────────────────────────────────────── */}
            ...
            <div className="space-y-4">
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between text-base">
                    <span className="flex items-center gap-2">
                      ...
                      />
                      Connect {settings.canalAPublished ? 'activé' : 'inactif'}
                    </span>
                    <Switch
                ...
                <CardContent className="space-y-3 pt-0">
                  {settings.canalAPublished ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <Button
                        size="sm"
                        onClick={() => toggle('canalAPublished')}
                        disabled={saving !== null}
              ...
              <Card
                className={cn(
                  ...
                  !settings.canalAPublished && 'opacity-60',
                )}
              >
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between text-base">
