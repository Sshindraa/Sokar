  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      ...
      <p className="mt-8 text-xs text-muted-foreground">
        En réservant, vous acceptez que vos informations soient transmises au restaurant
        pour gérer votre réservation. Vos données ne sont pas partagées avec des tiers.
      </p>
    </main>
  );
}
