 ...
 * Cf. spec canal-a-v1.1 §3.2 : "Zéro Clerk, zéro cookie auth, zéro header
...
export const metadata: Metadata = {
  ...
  description: 'Sokar rend votre restaurant réservable depuis Google, ChatGPT et les assistants IA.',
  robots: {
    index: true,
    follow: true,
    googleBot: {
