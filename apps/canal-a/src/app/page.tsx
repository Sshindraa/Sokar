    ...
    <main className="mx-auto max-w-6xl px-6 py-12">
      <header className="mb-12">
        ...
        <p className="mt-3 text-lg text-muted-foreground">
          Réseau de pages publiques Sokar rendant chaque restaurant client
          trouvable, compréhensible et réservable par les moteurs de recherche
      ...
      <footer className="mt-16 border-t border-border pt-6 text-sm text-muted-foreground">
        <p>
          Canal A — Phase 0 scaffold. Pour voir une page restaurant, ouvrez
          par exemple{' '}
